export class Router {
  ...
  route(event) {
      ...
      if(window.location.pathname == "/Terra") {
        document.body.style.backgroundImage = "url(../assets/Terra.png)"
    }
    if(window.location.pathname == "/Planeta") {
        document.body.style.backgroundImage = "url(../assets/Planeta.png)"
    }
